        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 34:
              ...
              cachedCode = new Set(['eosio', 'eosio']);
  ...
  */
  ...
  function transaction(arg, options, callback) {
    ...
    headers(options.expireInSeconds, checkError(callback, function _callee2(rawTx) {
      var requiredFeeTBufTxObject, requiredFeeTBuf, requiredFeeTr, feeObj, txObject, buf, tr, transactionId, sigs, chainIdBuf, signBuf;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              // @TODO 手续费临时解决方案
              requiredFeeTBufTxObject = Transaction.fromObject(rawTx);
            ...
            case 9:
              ...
              requiredFeeTBuf = Fcbuffer.toBuffer(Transaction, requiredFeeTBufTxObject);
              requiredFeeTr = Fcbuffer.fromBuffer(Transaction, requiredFeeTBuf);
              _context2.next = 13;
              return regeneratorRuntime.awrap(network.getRequiredFee({ transaction: requiredFeeTr }));

            case 13:
              feeObj = _context2.sent;

              assert.equal(_typeof(feeObj.required_fee), 'string', 'expecting required_fee string');
