...
var _require = require('./format'),
    ...
    parseAsset = _require.parseAsset;
...
describe('format', function () {
  ...
  it('parseAsset', function () {
    var parseExtendedAssets = [['SYM', null, null, 'SYM', null], ['SYM@contract', null, null, 'SYM', 'contract'], ['4,SYM', null, 4, 'SYM', null], ['4,SYM@contract', null, 4, 'SYM', 'contract'], ['1 SYM', '1', 0, 'SYM', null], ['1.0 SYM', '1.0', 1, 'SYM', null], ['1.0000 SYM@contract', '1.0000', 4, 'SYM', 'contract'], ['1.0000 SYM@tract.token', '1.0000', 4, 'SYM', 'tract.token'], ['1.0000 SYM@tr.act.token', '1.0000', 4, 'SYM', 'tr.act.token'], ['1.0000 SYM', '1.0000', 4, 'SYM', null]];
    ...
    try {
      for (var _iterator7 = parseExtendedAssets[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
        ...
        assert.deepEqual(parseAsset(str), { amount: amount, precision: precision, symbol: symbol, contract: contract }, JSON.stringify([str, amount, precision, symbol, contract]));
      }
    } catch (err) {
